    ...
    public partial class Principal : Form
    {
        ...
        private void btn_ant_Click(object sender, EventArgs e)
        {
            ...
            if (id == 9)
            {
                ...
                Double[] Setembro = { setembro };
                Double[] Outubro = { outubro };
                Double[] Novembro = { novembro };
        ...
        {
            if (checkBox1.Checked == true) { MessageBox.Show("Livro Solicitado, Meus Parabéns pela aquisição!"); }
